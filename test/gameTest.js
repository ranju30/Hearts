...
var players = [
    {
        ...
        getHand: sinon.stub().returns([{suit: "club", rank: "2"}, {suit: "diamond", rank: "A"}, {
            suit: "heart",
            rank: "A"
        }]),
        throwACard: function () {
...
describe("game", function () {
    describe("getStatus", function () {
        it("gives first player name and instructs to wait for others when game has not started", function () {
            var game = new Game();
            var player1 = {
                name: "player1", getHand: sinon.stub().returns("ola"), calculatePoints: function () {
                }, getPoints: function () {
    ...
    describe("updateHand", function () {
        ...
        it("should allow to play a card if suit is same", function () {
            ...
            assert.deepEqual([{suit: "club", rank: "2", playerName: "player1", priority: 2}, {
                suit: "club",
                rank: "K",
                playerName: "player3",
                priority: 13
    ...
    describe("isGameOver", function () {
        it("returns true if any 1 player gets 100 point", function () {
            var game = new Game();
            var allPlayers = [{name: "p1", getTotalPoints: sinon.stub().returns(110)}, {
                name: "p2",
                getTotalPoints: function () {
                }
            }];
    ...
    describe("isMoonShoot", function () {
        it("returns true if a player score 26 in one round", function () {
            var game = new Game();
            var allPlayers = [{name: "p1", getPoints: sinon.stub().returns(26)}, {
                name: "p2", getPoints: function () {
                }
            }];
            allPlayers.forEach(function (p) {
                game.join(p);
        ...
        it("returns return false if any player dont get 26", function () {
            var game = new Game();
            var allPlayers = [{name: "p1", getPoints: sinon.stub().returns(25)}, {
                name: "p2", getPoints: function () {
                }
            }];
            allPlayers.forEach(function (p) {
