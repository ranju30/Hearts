...
describe("Player", function () {
    ...
    describe("sortCards", function () {
        it("should sort the available cards in player hand", function () {
            ...
            player.take(card4);
            assert.deepEqual([{suit: "club", rank: "7"}, {suit: "diamond", rank: "6"}, {
                suit: "spade",
                rank: "A"
            }, {suit: "heart", rank: "10"}], player.getHand());
    ...
    describe("addPassedCards", function () {
        it("removes the cards from hand", function () {
            ...
            assert.deepEqual(player.getHand(), [{suit: "club", rank: "7"}, {suit: "diamond", rank: "6"}, {
                suit: "spade",
                rank: "A"
            }, {suit: "heart", rank: "10"}]);
        });
