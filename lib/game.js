...
var Game = function(){
	...
	this.getStatus = function(player){
		var result = {
			players: players.map(function(p){return {name:p.name,points:p.getPoints(),total:p.getTotalPoints()}}),
		...
		else if(playerTurn == undefined){
			result.instruction = 'Pass 3 cards and wait!!';
		}
		else{
