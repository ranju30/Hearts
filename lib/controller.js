...
app.get('/logout',function(req,res){
	...
	console.log('Cookie after logout:',req.cookies.userName);
	res.redirect('login.html');
});
...
app.get('/endGame',ensureLoggedIn,ensureGameOn,deleteGame);
